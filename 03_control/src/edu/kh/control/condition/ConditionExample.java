...
public class ConditionExample { //기능 제공용 클래스
	...
	Scanner sc= new Scanner(System.in); //import 자동 단축키 : ctrl shift o
	public void ex1() {
		//if문
	...
	public void ex4() {
		...
		if(month ==1 || month ==2 || month ==12) {
			...
			if (temperature <= -15) {
				//겨울 한파 경보
				season += "한파 경보"; //season = season + "한파 경보";
	...
	public void ex6() {
		System.out.println("점수(100점 만점)를 입력하세요");
		int input = sc.nextInt();
