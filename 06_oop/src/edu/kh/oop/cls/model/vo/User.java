...
public class User {
	...
	//private String userId; ->Duplicate field User.userId 중복된다
	//public User() {} ->Duplicate method User() in type User 중복된다
