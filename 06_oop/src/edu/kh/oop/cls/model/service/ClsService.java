...
public class ClsService /*extends Student*/ {
	...
	public void ex1() {
		...
		//상속 관계에서 직접접근 가능범위 테스트
		//System.out.println(v1); //public=프로그램전체에서 접근 가능
		///System.out.println(v2); 
		//Student 클래스를 상속받았으므로 Student의 protected 변수인
		//v2는 직접 접근 가능
		//System.out.println(v3); //(default) 다른패키지라 X
		//System.out.println(v4);	// 해당클래스가 아닌 다른클래스라 X
	}
