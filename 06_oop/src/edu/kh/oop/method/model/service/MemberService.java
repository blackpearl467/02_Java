...
public class MemberService {
	...
	//스캐너라는 클래스를 수입(import)해와서 객체를 만듦
	...
	public String signUp() {
		...
		String memberId=sc.next(); //메서드안에서 만들어진 변수는 지역변수임
	...
	public String login() {
		...
		if(memberId.equals(memberInfo.getMemberId()) &&
			...
			//memberInfo필드에서 참조중인 Member객체의 memberPw가 같은지 확인
	...
	public String selectMember() {
		...
		str += "\n아이디 : " + loginMember.getMemberId();//+= 누적의 의미도 있음
