...
public class VariableExample2 {
	...
	public static void main(String[] args) {
		...
		booleanData = true; //booleanData변수에 true논리값 집어넣기 (대입)
		...
		short shortNumber = 32767; //32768 에러
		
		//정수 자료형 기본형!(short, byte 는 옛날코드 잔재)
		int intNumber = 214483647; //214483648 에러
	//자료형	변수명 = 리터럴;		
		...
		long longNumber = 10000000000L; // L 또는 l 가능
